...
#define RI_EXCP_OFFSET			0x08
#define ZDIV_EXCP_OFFSET		0x0C
#define BRK_EXCP_OFFSET			0x10
#define SWI_EXCP_OFFSET			0x14
#define DEBUG_EXCP_OFFSET		0x18 // dret
#define DSP_EXCP_OFFSET			0x1C
#define COP_EXCP_OFFSET			0x20

#define EXCP_INJECT_JUMP		0x28D90080

#define EXCP_CODE_BASE_OFFSET	0x24
